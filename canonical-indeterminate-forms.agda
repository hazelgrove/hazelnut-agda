...
module canonical-indeterminate-forms where
  ...
  canonical-indeterminate-forms-coverage : ∀{Δ d τ} →
                                           ...
                                           τ ≠ ⦇-⦈ →
                                           ⊥
  canonical-indeterminate-forms-coverage {τ = num} wt ind nn na ns nh = nn refl
  canonical-indeterminate-forms-coverage {τ = ⦇-⦈} wt ind nn na ns nh = nh refl
  canonical-indeterminate-forms-coverage {τ = τ ==> τ₁} wt ind nn na ns nh = na τ τ₁ refl
  canonical-indeterminate-forms-coverage {τ = τ ⊕ τ₁} wt ind nn na ns nh = ns τ τ₁ refl
